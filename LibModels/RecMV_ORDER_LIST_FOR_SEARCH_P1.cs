...
{
    public class RecMV_ORDER_LIST_FOR_SEARCH_P1 : RecordBase
    {
		...
		/// コンストラクタ
		/// </summary>
		public RecMV_ORDER_LIST_FOR_SEARCH_P1() { }
		public RecMV_ORDER_LIST_FOR_SEARCH_P1 Copy() => (RecMV_ORDER_LIST_FOR_SEARCH_P1)this.MemberwiseClone();
	}
}
